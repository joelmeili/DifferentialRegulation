...
curl ftp://ftp.ebi.ac.uk/pub/databases/gencode/Gencode_human/release_38/gencode.v38.annotation.gtf.gz --output brain_human/01_annotation/gencode.v38.annotation.gtf.gz
curl ftp://ftp.ebi.ac.uk/pub/databases/gencode/Gencode_human/release_38/GRCh38.primary_assembly.genome.fa.gz --output brain_human/01_annotation/GRCh38.primary_assembly.genome.fa.gz
